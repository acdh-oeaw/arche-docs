...
* `{pointed to}` and `{pointed from}` are binary flags (they take only values od `0` or `1`) and indicate if resources pointing to the **_requested resource_** and pointed from the **_requested resource_** should be included
