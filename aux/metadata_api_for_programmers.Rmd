...
* `{pointed to}` and `{pointed from}` are binary flags (they take only values od `0` or `1`) and indicate if resources pointed by the **_requested resource_** and pointing to the **_requested resource_** should be included, respectively
