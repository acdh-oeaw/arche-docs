---
title: "Metadata API performance"
output:
  html_document:
    df_print: paged
---
...
A few tests were performed on a i7-6700HQ (4c/8t@2.6GHz) with a 4x16GB@2133MHz RAM and a 2xSATA SSD in RAID-0.
The repository contained 85k resources and 2.6M triples.

```{r echo=FALSE, message=FALSE, warning=FALSE, fig.width=8}
library(magrittr)
d = readr::read_csv2('~/Pobrane/stats.csv') %>%
  dplyr::mutate(
