---
title: "ARCHE Parallel Ingestion"
output:
  html_document: 
    toc: yes
---
...
Unfortunately this approach works only if we have a guarantee that a resource can not be created in between of the search and update operations (a so-called atomicity guarantee).
